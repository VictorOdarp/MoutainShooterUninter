...
from code.Const import COLOR_WHITE, WIN_HEIGHT, MENU_OPTION, EVENT_ENEMY, COLOR_GREEN, COLOR_CYAN, SPAWN_TIME, \
    TIMEOUT_STEP, EVENT_TIMEOUT, TIMEOUT_LEVEL
...
class Level:
    ...
    def run(self, player_score):
        ...
        while True:
            ...
            self.level_text(14, f'FPS: {clock.get_fps() : .1f}s', COLOR_WHITE, (10, WIN_HEIGHT - 35))
